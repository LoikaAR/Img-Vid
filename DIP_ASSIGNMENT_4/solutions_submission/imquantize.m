...
% [pics, avg_list, classes] = CIELab_Palette(impath, nClusters, false, false);
...
montage({img, out, grey}, Size=[1 NaN], BorderSize=[2,2]);
title("Image quantizaion, " + nClusters + " colors");